...
const createWindow = () => {
  ...
  const mainWindow = new BrowserWindow({
    ...
    titleBarOverlay: {
        // color of titile bar
        color: '#2f3438', /* penser à modifier la couleurs aussi dans le style.css var --header-color  */
        // color of titile bar control
        symbolColor: '#fafafa', /* penser à modifier la couleurs aussi dans le style.css var --header-color  */
